                ...
                {averageData !== undefined && 
                    <div className="row">
                        <div className="col s-4">
                            <h3>Total Average:</h3>
                            <div style={{ color: averageData.total_average > 130 ? 'red' : 'white' }}>
                        ...
                        <div className="row col s8">
                            <div className="col s3">
                                <h5>Morning</h5>
                                <div style={{ color: averageData.morning > 130 ? 'red' : 'white' }}>
                                    <p>{averageData.morning} mg/dl</p>
                                </div>
                            </div>
                            <div className="col s3">
                                <h5>preBreakfast</h5>
                                <div style={{ color: averageData.preBreakfast > 130 ? 'red' : 'white' }}>
                                    <p>{averageData.preBreakfast} mg/dl</p>
                                </div>
                            </div>
                            <div className="col s3">
                                <h5>postBreakfast</h5>
                                <div style={{ color: averageData.postBreakfast > 130 ? 'red' : 'white' }}>
                                    <p>{averageData.postBreakfast} mg/dl</p>
                                </div>    
                            </div>
                            <div className="col s3">
                                <h5>preLunch</h5>
                                <div style={{ color: averageData.preLunch > 130 ? 'red' : 'white' }}>
                            ...
                            <div className="col s3">
                                <h5>postLunch</h5>
                                <div style={{ color: averageData.postLunch > 130 ? 'red' : 'white' }}>
                                    <p>{averageData.postLunch} mg/dl</p>
                                </div>    
                            </div>
                            <div className="col s3">
                                <h5>preDinner</h5>
                                <div style={{ color: averageData.preDinner > 130 ? 'red' : 'white' }}>
                                    <p>{averageData.preDinner} mg/dl</p>
                                </div>
                            </div>
                            <div className="col s3">
                                <h5>postDinner</h5>
                                <div style={{ color: averageData.postDinner > 130 ? 'red' : 'white' }}>
                                    <p>{averageData.postDinner} mg/dl</p>
                                </div>    
                            </div>
                            <div className="col s3">
                                <h5>Night</h5>
                                <div style={{ color: averageData.night > 130 ? 'red' : 'white' }}>
